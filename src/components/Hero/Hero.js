...
import VantaBackground from '../BackgroundAnimation/VantaBackground';
...
const Hero = (props) => (
  <Section row nopadding>
    <LeftSection>
      ...
      <Button onClick={() => window.location = 'https://x.com/Vedangggstfu'}>posting bangers on twt 24/7 here</Button>
